...
def load_config(app: Flask, test_config) -> None:
    ...
    elif os.environ.get('FLASK_ENV') == 'development' or test_config.get("FLASK_ENV") == 'development':
        app.config.from_object('app.config.Development')

    elif os.environ.get('FLASK_ENV') == 'staging' or test_config.get("FLASK_ENV") == 'staging':
        app.config.from_object('app.config.Staging')
